...
.method private containsAsync(Lcom/facebook/cache/common/CacheKey;)Le/j;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, v1}, Le/j;->a(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Le/j;
    ...
    invoke-static {v0}, Le/j;->b(Ljava/lang/Exception;)Le/j;
...
.method private foundPinnedImage(Lcom/facebook/cache/common/CacheKey;Lcom/facebook/imagepipeline/image/EncodedImage;)Le/j;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private getAsync(Lcom/facebook/cache/common/CacheKey;Ljava/util/concurrent/atomic/AtomicBoolean;)Le/j;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, p2}, Le/j;->a(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Le/j;
    ...
    invoke-static {p2}, Le/j;->b(Ljava/lang/Exception;)Le/j;
...
.method public contains(Lcom/facebook/cache/common/CacheKey;)Le/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/facebook/imagepipeline/cache/BufferedDiskCache;->containsAsync(Lcom/facebook/cache/common/CacheKey;)Le/j;
...
.method public get(Lcom/facebook/cache/common/CacheKey;Ljava/util/concurrent/atomic/AtomicBoolean;)Le/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, v0}, Lcom/facebook/imagepipeline/cache/BufferedDiskCache;->foundPinnedImage(Lcom/facebook/cache/common/CacheKey;Lcom/facebook/imagepipeline/image/EncodedImage;)Le/j;
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Lcom/facebook/imagepipeline/cache/BufferedDiskCache;->getAsync(Lcom/facebook/cache/common/CacheKey;Ljava/util/concurrent/atomic/AtomicBoolean;)Le/j;
...
.method public remove(Lcom/facebook/cache/common/CacheKey;)Le/j;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
