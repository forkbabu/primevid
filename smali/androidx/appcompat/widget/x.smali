...
.field f:Landroidx/appcompat/widget/x$c;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    sget v0, Ld/a/a$b;->spinnerStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    sget-object v0, Ld/a/a$l;->Spinner:[I
    ...
    new-instance v3, Ld/a/e/d;

    invoke-direct {v3, p1, p5}, Ld/a/e/d;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V

    iput-object v3, p0, Landroidx/appcompat/widget/x;->b:Landroid/content/Context;

    goto :goto_1

    :cond_0
    sget p5, Ld/a/a$l;->Spinner_popupTheme:I

    invoke-virtual {v0, p5, v1}, Landroidx/appcompat/widget/x0;->g(II)I
    ...
    invoke-direct {v3, p1, p5}, Ld/a/e/d;-><init>(Landroid/content/Context;I)V
    ...
    :goto_0
    iput-object p5, p0, Landroidx/appcompat/widget/x;->b:Landroid/content/Context;

    :goto_1
    iget-object p5, p0, Landroidx/appcompat/widget/x;->b:Landroid/content/Context;
    ...
    invoke-direct {p4, p0, p5, p2, p3}, Landroidx/appcompat/widget/x$c;-><init>(Landroidx/appcompat/widget/x;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iget-object p5, p0, Landroidx/appcompat/widget/x;->b:Landroid/content/Context;

    sget-object v4, Ld/a/a$l;->Spinner:[I
    ...
    sget v1, Ld/a/a$l;->Spinner_android_dropDownWidth:I
    ...
    iput v1, p0, Landroidx/appcompat/widget/x;->g:I

    sget v1, Ld/a/a$l;->Spinner_android_popupBackground:I

    invoke-virtual {p5, v1}, Landroidx/appcompat/widget/x0;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    invoke-virtual {p4, v1}, Landroidx/appcompat/widget/i0;->a(Landroid/graphics/drawable/Drawable;)V

    sget v1, Ld/a/a$l;->Spinner_android_prompt:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/x0;->f(I)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p4, v1}, Landroidx/appcompat/widget/x$c;->a(Ljava/lang/CharSequence;)V

    invoke-virtual {p5}, Landroidx/appcompat/widget/x0;->f()V

    iput-object p4, p0, Landroidx/appcompat/widget/x;->f:Landroidx/appcompat/widget/x$c;

    new-instance p5, Landroidx/appcompat/widget/x$a;

    invoke-direct {p5, p0, p0, p4}, Landroidx/appcompat/widget/x$a;-><init>(Landroidx/appcompat/widget/x;Landroid/view/View;Landroidx/appcompat/widget/x$c;)V

    iput-object p5, p0, Landroidx/appcompat/widget/x;->c:Landroidx/appcompat/widget/g0;

    :cond_6
    sget p4, Ld/a/a$l;->Spinner_android_entries:I

    invoke-virtual {v0, p4}, Landroidx/appcompat/widget/x0;->h(I)[Ljava/lang/CharSequence;
    ...
    sget p1, Ld/a/a$i;->support_simple_spinner_dropdown_item:I

    invoke-virtual {p5, p1}, Landroid/widget/ArrayAdapter;->setDropDownViewResource(I)V

    invoke-virtual {p0, p5}, Landroidx/appcompat/widget/x;->setAdapter(Landroid/widget/SpinnerAdapter;)V

    :cond_7
    invoke-virtual {v0}, Landroidx/appcompat/widget/x0;->f()V

    iput-boolean v3, p0, Landroidx/appcompat/widget/x;->e:Z
...
.method public getDropDownHorizontalOffset()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/x;->f:Landroidx/appcompat/widget/x$c;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Landroidx/appcompat/widget/i0;->g()I
...
.method public getDropDownVerticalOffset()I
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/i0;->o()I
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/i0;->e()Landroid/graphics/drawable/Drawable;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/x$c;->v()Ljava/lang/CharSequence;
...
.method protected onMeasure(II)V
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/x;->f:Landroidx/appcompat/widget/x$c;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/x;->c:Landroidx/appcompat/widget/g0;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    :cond_1
    iget-object v1, p0, Landroidx/appcompat/widget/x;->f:Landroidx/appcompat/widget/x$c;
    ...
    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/x$c;->a(Landroid/widget/ListAdapter;)V
...
.method public setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/i0;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/x$c;->a(Ljava/lang/CharSequence;)V
