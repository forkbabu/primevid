...
.field private final l:Landroidx/appcompat/widget/j0;
...
.field private x:Landroidx/appcompat/view/menu/p$a;
...
.method static constructor <clinit>()V
    ...
    sget v0, Ld/a/a$i;->abc_cascading_menu_item_layout:I

    sput v0, Landroidx/appcompat/view/menu/e;->B:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/e;->l:Landroidx/appcompat/widget/j0;
    ...
    iput-object p2, p0, Landroidx/appcompat/view/menu/e;->o:Landroid/view/View;
...
.method private d(I)I
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/e;->p:Landroid/view/View;
...
.method private d(Landroidx/appcompat/view/menu/h;)V
    ...
    sget v3, Landroidx/appcompat/view/menu/e;->B:I
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/e;->f()Landroidx/appcompat/widget/k0;
    ...
    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/i0;->d(I)V
    ...
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/k0;->e(Z)V
    ...
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/i0;->b(Landroid/view/View;)V
    ...
    iget-object v12, p0, Landroidx/appcompat/view/menu/e;->o:Landroid/view/View;
    ...
    iget v12, p0, Landroidx/appcompat/view/menu/e;->n:I
    ...
    iget-object v13, p0, Landroidx/appcompat/view/menu/e;->o:Landroid/view/View;
    ...
    :goto_3
    iget v10, p0, Landroidx/appcompat/view/menu/e;->n:I
    ...
    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/i0;->d(Z)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/e$d;-><init>(Landroidx/appcompat/widget/k0;Landroidx/appcompat/view/menu/h;I)V
    ...
    invoke-virtual {v4}, Landroidx/appcompat/widget/i0;->c()Landroid/widget/ListView;
    ...
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/h;->i()Ljava/lang/CharSequence;

    move-result-object v1

    if-eqz v1, :cond_c

    sget v1, Ld/a/a$i;->abc_popup_menu_header_item_layout:I
...
.method private f()Landroidx/appcompat/widget/k0;
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/e;->l:Landroidx/appcompat/widget/j0;
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/e;->o:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/i0;->b(Landroid/view/View;)V
...
.method public a(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/e;->z:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public a(Landroidx/appcompat/view/menu/h;Z)V
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/e$d;->a:Landroidx/appcompat/widget/k0;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/k0;->b(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/e$d;->a:Landroidx/appcompat/widget/k0;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/i0;->b(I)V

    :cond_2
    iget-object v0, v0, Landroidx/appcompat/view/menu/e$d;->a:Landroidx/appcompat/widget/k0;
    ...
    iget-object p2, p0, Landroidx/appcompat/view/menu/e;->x:Landroidx/appcompat/view/menu/p$a;
    ...
    :cond_4
    iget-object p1, p0, Landroidx/appcompat/view/menu/e;->y:Landroid/view/ViewTreeObserver;
    ...
    iget-object p2, p0, Landroidx/appcompat/view/menu/e;->j:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    invoke-virtual {p1, p2}, Landroid/view/ViewTreeObserver;->removeGlobalOnLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    :cond_5
    iput-object v2, p0, Landroidx/appcompat/view/menu/e;->y:Landroid/view/ViewTreeObserver;

    :cond_6
    iget-object p1, p0, Landroidx/appcompat/view/menu/e;->p:Landroid/view/View;

    iget-object p2, p0, Landroidx/appcompat/view/menu/e;->k:Landroid/view/View$OnAttachStateChangeListener;

    invoke-virtual {p1, p2}, Landroid/view/View;->removeOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    iget-object p1, p0, Landroidx/appcompat/view/menu/e;->z:Landroid/widget/PopupWindow$OnDismissListener;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/e;->i:Ljava/util/List;
...
.method public a(Landroidx/appcompat/view/menu/p$a;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/e;->x:Landroidx/appcompat/view/menu/p$a;
...
.method public a(Landroidx/appcompat/view/menu/v;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/e;->x:Landroidx/appcompat/view/menu/p$a;
...
.method public dismiss()V
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/e$d;->a:Landroidx/appcompat/widget/k0;

    invoke-virtual {v3}, Landroidx/appcompat/widget/i0;->isShowing()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroidx/appcompat/view/menu/e$d;->a:Landroidx/appcompat/widget/k0;
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/e$d;->a:Landroidx/appcompat/widget/k0;

    invoke-virtual {v4}, Landroidx/appcompat/widget/i0;->isShowing()Z
...
.method public show()V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/e;->y:Landroid/view/ViewTreeObserver;
    ...
    iput-object v1, p0, Landroidx/appcompat/view/menu/e;->y:Landroid/view/ViewTreeObserver;

    if-eqz v0, :cond_3

    iget-object v0, p0, Landroidx/appcompat/view/menu/e;->j:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
