...
# static fields
.field static final j1:Ljava/lang/String; = "MediaRouteCtrlDialog"

.field static final k1:Z

.field static final l1:I = 0x1f4

.field static final m1:I

.field private static final n1:I = 0x102001b

.field static final o1:I = 0x102001a

.field static final p1:I = 0x1020019
...
.field L0:Landroid/support/v4/media/session/MediaControllerCompat;

.field M:Landroidx/mediarouter/app/d$q;

.field M0:Landroidx/mediarouter/app/d$o;

.field N:Ld/t/b/k$g;

.field N0:Landroid/support/v4/media/session/PlaybackStateCompat;

.field private O:I

.field O0:Landroid/support/v4/media/MediaDescriptionCompat;

.field private P:I

.field P0:Landroidx/mediarouter/app/d$n;

.field Q0:Landroid/graphics/Bitmap;

.field R0:Landroid/net/Uri;
...
.field private d1:Landroid/view/animation/Interpolator;

.field private e1:Landroid/view/animation/Interpolator;

.field final f:Ld/t/b/k;

.field private f1:Landroid/view/animation/Interpolator;

.field private final g:Landroidx/mediarouter/app/d$p;

.field private g1:Landroid/view/animation/Interpolator;

.field final h:Ld/t/b/k$g;

.field final h1:Landroid/view/accessibility/AccessibilityManager;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroidx/mediarouter/app/d;->k1:Z
    ...
    sput v1, Landroidx/mediarouter/app/d;->m1:I
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object p2, p0, Landroidx/mediarouter/app/d;->i1:Ljava/lang/Runnable;
    ...
    iput-object p2, p0, Landroidx/mediarouter/app/d;->M0:Landroidx/mediarouter/app/d$o;

    iget-object p2, p0, Landroidx/mediarouter/app/d;->i:Landroid/content/Context;

    invoke-static {p2}, Ld/t/b/k;->a(Landroid/content/Context;)Ld/t/b/k;

    move-result-object p2

    iput-object p2, p0, Landroidx/mediarouter/app/d;->f:Ld/t/b/k;
    ...
    iget-object p2, p0, Landroidx/mediarouter/app/d;->f:Ld/t/b/k;

    invoke-virtual {p2}, Ld/t/b/k;->f()Ld/t/b/k$g;

    move-result-object p2

    iput-object p2, p0, Landroidx/mediarouter/app/d;->h:Ld/t/b/k$g;

    iget-object p2, p0, Landroidx/mediarouter/app/d;->f:Ld/t/b/k;

    invoke-virtual {p2}, Ld/t/b/k;->c()Landroid/support/v4/media/session/MediaSessionCompat$Token;

    move-result-object p2

    invoke-direct {p0, p2}, Landroidx/mediarouter/app/d;->a(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    sget v0, Ld/t/a$e;->mr_controller_volume_group_list_padding_top:I

    invoke-virtual {p2, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result p2

    iput p2, p0, Landroidx/mediarouter/app/d;->J0:I
    ...
    iput-object p2, p0, Landroidx/mediarouter/app/d;->h1:Landroid/view/accessibility/AccessibilityManager;
    ...
    sget p2, Ld/t/a$i;->mr_linear_out_slow_in:I

    invoke-static {p1, p2}, Landroid/view/animation/AnimationUtils;->loadInterpolator(Landroid/content/Context;I)Landroid/view/animation/Interpolator;

    move-result-object p2

    iput-object p2, p0, Landroidx/mediarouter/app/d;->e1:Landroid/view/animation/Interpolator;

    sget p2, Ld/t/a$i;->mr_fast_out_slow_in:I

    invoke-static {p1, p2}, Landroid/view/animation/AnimationUtils;->loadInterpolator(Landroid/content/Context;I)Landroid/view/animation/Interpolator;

    move-result-object p1

    iput-object p1, p0, Landroidx/mediarouter/app/d;->f1:Landroid/view/animation/Interpolator;
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/d;->g1:Landroid/view/animation/Interpolator;
...
.method private a(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/d;->L0:Landroid/support/v4/media/session/MediaControllerCompat;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iget-object v2, p0, Landroidx/mediarouter/app/d;->M0:Landroidx/mediarouter/app/d$o;
    ...
    iput-object v1, p0, Landroidx/mediarouter/app/d;->L0:Landroid/support/v4/media/session/MediaControllerCompat;
    ...
    iput-object v0, p0, Landroidx/mediarouter/app/d;->L0:Landroid/support/v4/media/session/MediaControllerCompat;
    :try_end_0
    ...
    :goto_0
    iget-object p1, p0, Landroidx/mediarouter/app/d;->L0:Landroid/support/v4/media/session/MediaControllerCompat;

    if-eqz p1, :cond_3

    iget-object v0, p0, Landroidx/mediarouter/app/d;->M0:Landroidx/mediarouter/app/d$o;
    ...
    :goto_2
    iput-object p1, p0, Landroidx/mediarouter/app/d;->O0:Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    :cond_6
    invoke-virtual {p1}, Landroid/support/v4/media/session/MediaControllerCompat;->g()Landroid/support/v4/media/session/PlaybackStateCompat;

    move-result-object v1

    :goto_3
    iput-object v1, p0, Landroidx/mediarouter/app/d;->N0:Landroid/support/v4/media/session/PlaybackStateCompat;

    invoke-virtual {p0}, Landroidx/mediarouter/app/d;->o()V

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Landroidx/mediarouter/app/d;->d(Z)V
...
.method private a(Landroid/view/View;I)V
    ...
    invoke-static {p1}, Landroidx/mediarouter/app/d;->d(Landroid/view/View;)I
    ...
    iget p2, p0, Landroidx/mediarouter/app/d;->a1:I
    ...
    iget-object p2, p0, Landroidx/mediarouter/app/d;->d1:Landroid/view/animation/Interpolator;
...
.method private h(Z)V
    ...
    invoke-direct {p0}, Landroidx/mediarouter/app/d;->s()Ld/t/b/k$f;
    ...
    invoke-static {v2, v0}, Landroidx/mediarouter/app/h;->c(Ljava/util/List;Ljava/util/List;)Z
    ...
    invoke-static {v2, v3}, Landroidx/mediarouter/app/h;->a(Landroid/widget/ListView;Landroid/widget/ArrayAdapter;)Ljava/util/HashMap;
    ...
    invoke-static {v3, v4, v5}, Landroidx/mediarouter/app/h;->a(Landroid/content/Context;Landroid/widget/ListView;Landroid/widget/ArrayAdapter;)Ljava/util/HashMap;
    ...
    invoke-static {v4, v0}, Landroidx/mediarouter/app/h;->a(Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-static {v4, v0}, Landroidx/mediarouter/app/h;->b(Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    iget-boolean p1, p0, Landroidx/mediarouter/app/d;->X0:Z
    ...
    invoke-direct {p0, v2, v3}, Landroidx/mediarouter/app/d;->b(Ljava/util/Map;Ljava/util/Map;)V
...
.method private q()Z
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/d;->O0:Landroid/support/v4/media/MediaDescriptionCompat;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroidx/mediarouter/app/d;->N0:Landroid/support/v4/media/session/PlaybackStateCompat;
...
.method private r()V
    ...
    iget v6, p0, Landroidx/mediarouter/app/d;->b1:I
...
.method private s()Ld/t/b/k$f;
    .locals 2

    iget-object v0, p0, Landroidx/mediarouter/app/d;->h:Ld/t/b/k$g;
...
.method private t()Z
    ...
    :goto_0
    iget-object v2, p0, Landroidx/mediarouter/app/d;->O0:Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    :goto_1
    iget-object v2, p0, Landroidx/mediarouter/app/d;->P0:Landroidx/mediarouter/app/d$n;

    if-nez v2, :cond_2

    iget-object v2, p0, Landroidx/mediarouter/app/d;->Q0:Landroid/graphics/Bitmap;

    goto :goto_2

    :cond_2
    invoke-virtual {v2}, Landroidx/mediarouter/app/d$n;->a()Landroid/graphics/Bitmap;

    move-result-object v2

    :goto_2
    iget-object v3, p0, Landroidx/mediarouter/app/d;->P0:Landroidx/mediarouter/app/d$n;

    if-nez v3, :cond_3

    iget-object v3, p0, Landroidx/mediarouter/app/d;->R0:Landroid/net/Uri;

    goto :goto_3

    :cond_3
    invoke-virtual {v3}, Landroidx/mediarouter/app/d$n;->b()Landroid/net/Uri;
    ...
    invoke-static {v3, v1}, Landroidx/mediarouter/app/d;->a(Landroid/net/Uri;Landroid/net/Uri;)Z
...
.method private u()V
    ...
    invoke-direct {p0}, Landroidx/mediarouter/app/d;->q()Z
    ...
    iget-object v4, p0, Landroidx/mediarouter/app/d;->O0:Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    iget-object v5, p0, Landroidx/mediarouter/app/d;->h:Ld/t/b/k$g;

    invoke-virtual {v5}, Ld/t/b/k$g;->n()I
    ...
    sget v1, Ld/t/a$k;->mr_controller_casting_screen:I
    ...
    :cond_3
    iget-object v5, p0, Landroidx/mediarouter/app/d;->N0:Landroid/support/v4/media/session/PlaybackStateCompat;

    if-eqz v5, :cond_7

    invoke-virtual {v5}, Landroid/support/v4/media/session/PlaybackStateCompat;->m()I
    ...
    sget v1, Ld/t/a$k;->mr_controller_no_info_available:I
    ...
    sget v1, Ld/t/a$k;->mr_controller_no_media_selected:I
    ...
    invoke-virtual {v0}, Landroid/support/v4/media/session/PlaybackStateCompat;->m()I
    ...
    sget v0, Ld/t/a$b;->mediaRoutePauseDrawable:I

    sget v2, Ld/t/a$k;->mr_controller_pause:I
    ...
    invoke-virtual {p0}, Landroidx/mediarouter/app/d;->j()Z

    move-result v2

    if-eqz v2, :cond_d

    sget v0, Ld/t/a$b;->mediaRouteStopDrawable:I

    sget v2, Ld/t/a$k;->mr_controller_stop:I
    ...
    sget v0, Ld/t/a$b;->mediaRoutePlayDrawable:I

    sget v2, Ld/t/a$k;->mr_controller_play:I
    ...
    invoke-static {v1, v0}, Landroidx/mediarouter/app/j;->c(Landroid/content/Context;I)I
...
.method private v()V
    ...
    invoke-virtual {p0, v0}, Landroidx/mediarouter/app/d;->a(Ld/t/b/k$g;)Z
    ...
    iget-object v3, p0, Landroidx/mediarouter/app/d;->h:Ld/t/b/k$g;

    invoke-virtual {v3}, Ld/t/b/k$g;->t()I
    ...
    invoke-virtual {v3}, Ld/t/b/k$g;->r()I
...
.method a(Ljava/util/Map;Ljava/util/Map;)V
    ...
    iget v14, v0, Landroidx/mediarouter/app/d;->b1:I
    ...
    iget v8, v0, Landroidx/mediarouter/app/d;->a1:I
    ...
    iget-object v8, v0, Landroidx/mediarouter/app/d;->d1:Landroid/view/animation/Interpolator;
    ...
    iget v5, v0, Landroidx/mediarouter/app/d;->c1:I
    ...
    iget-object v5, v0, Landroidx/mediarouter/app/d;->d1:Landroid/view/animation/Interpolator;
    ...
    iget v6, v0, Landroidx/mediarouter/app/d;->a1:I
    ...
    iget-object v6, v0, Landroidx/mediarouter/app/d;->d1:Landroid/view/animation/Interpolator;
    ...
    invoke-direct {v6, v0, v5}, Landroidx/mediarouter/app/d$a;-><init>(Landroidx/mediarouter/app/d;Ld/t/b/k$g;)V
    ...
    iget-object v6, v0, Landroidx/mediarouter/app/d;->K:Ljava/util/Set;

    invoke-interface {v6, v5}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    :goto_3
    iget-object v5, v0, Landroidx/mediarouter/app/d;->F:Landroidx/mediarouter/app/OverlayListView;
...
.method a(Z)V
    ...
    :cond_0
    sget v4, Ld/t/a$g;->volume_item_container:I
    ...
    invoke-virtual {p0, v1}, Landroidx/mediarouter/app/d;->b(Z)V

    :cond_2
    return-void
.end method

.method a(Ld/t/b/k$g;)Z
    .locals 2
...
.method b(Z)V
    ...
    iget-boolean v1, p0, Landroidx/mediarouter/app/d;->Z0:Z

    if-eqz v1, :cond_0

    iput-boolean v0, p0, Landroidx/mediarouter/app/d;->Z0:Z

    invoke-virtual {p0, p1}, Landroidx/mediarouter/app/d;->e(Z)V
...
.method c(Landroid/view/View;)V
    ...
    sget v0, Ld/t/a$g;->volume_item_container:I
    ...
    invoke-static {v0, v1}, Landroidx/mediarouter/app/d;->b(Landroid/view/View;I)V

    sget v0, Ld/t/a$g;->mr_volume_item_icon:I
...
.method public c(Z)V
    ...
    iget-boolean p1, p0, Landroidx/mediarouter/app/d;->j:Z
...
.method d()V
    ...
    iput-boolean v0, p0, Landroidx/mediarouter/app/d;->S0:Z

    const/4 v1, 0x0

    iput-object v1, p0, Landroidx/mediarouter/app/d;->T0:Landroid/graphics/Bitmap;
...
.method d(Z)V
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/d;->N:Ld/t/b/k$g;

    if-eqz v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroidx/mediarouter/app/d;->V0:Z

    iget-boolean v0, p0, Landroidx/mediarouter/app/d;->W0:Z

    or-int/2addr p1, v0

    iput-boolean p1, p0, Landroidx/mediarouter/app/d;->W0:Z
    ...
    iput-boolean v0, p0, Landroidx/mediarouter/app/d;->W0:Z

    iget-object v1, p0, Landroidx/mediarouter/app/d;->h:Ld/t/b/k$g;

    invoke-virtual {v1}, Ld/t/b/k$g;->B()Z
    ...
    invoke-virtual {v1}, Ld/t/b/k$g;->x()Z
    ...
    iget-object v2, p0, Landroidx/mediarouter/app/d;->h:Ld/t/b/k$g;

    invoke-virtual {v2}, Ld/t/b/k$g;->j()Ljava/lang/String;
    ...
    iget-boolean v0, p0, Landroidx/mediarouter/app/d;->S0:Z

    if-eqz v0, :cond_5

    iget-object v0, p0, Landroidx/mediarouter/app/d;->T0:Landroid/graphics/Bitmap;

    invoke-static {v0}, Landroidx/mediarouter/app/d;->a(Landroid/graphics/Bitmap;)Z
    ...
    iget-object v1, p0, Landroidx/mediarouter/app/d;->T0:Landroid/graphics/Bitmap;
    ...
    :cond_5
    invoke-direct {p0}, Landroidx/mediarouter/app/d;->v()V
...
.method f(Z)V
    ...
    invoke-static {v0}, Landroidx/mediarouter/app/d;->d(Landroid/view/View;)I
    ...
    invoke-static {v1, v2}, Landroidx/mediarouter/app/d;->b(Landroid/view/View;I)V

    invoke-direct {p0}, Landroidx/mediarouter/app/d;->q()Z

    move-result v1

    invoke-direct {p0, v1}, Landroidx/mediarouter/app/d;->i(Z)V
    ...
    invoke-static {v2, v0}, Landroidx/mediarouter/app/d;->b(Landroid/view/View;I)V
    ...
    invoke-virtual {p0, v2, v4}, Landroidx/mediarouter/app/d;->a(II)I
    ...
    invoke-direct {p0, v0}, Landroidx/mediarouter/app/d;->g(Z)I
    ...
    invoke-virtual {v6}, Ld/t/b/k$f;->E()Ljava/util/List;
    ...
    iget v4, p0, Landroidx/mediarouter/app/d;->J0:I

    add-int/2addr v5, v4

    :cond_3
    iget v4, p0, Landroidx/mediarouter/app/d;->I0:I

    invoke-static {v5, v4}, Ljava/lang/Math;->min(II)I

    move-result v4

    iget-boolean v5, p0, Landroidx/mediarouter/app/d;->X0:Z
    ...
    invoke-static {v0, v2}, Landroidx/mediarouter/app/d;->b(Landroid/view/View;I)V
    ...
    invoke-static {v1}, Landroidx/mediarouter/app/d;->d(Landroid/view/View;)I
    ...
    :goto_6
    invoke-direct {p0, v0}, Landroidx/mediarouter/app/d;->i(Z)V
    ...
    :cond_9
    invoke-direct {p0, v3}, Landroidx/mediarouter/app/d;->g(Z)I
    ...
    invoke-direct {p0, v1, v0}, Landroidx/mediarouter/app/d;->a(Landroid/view/View;I)V

    iget-object v0, p0, Landroidx/mediarouter/app/d;->F:Landroidx/mediarouter/app/OverlayListView;

    invoke-direct {p0, v0, v4}, Landroidx/mediarouter/app/d;->a(Landroid/view/View;I)V

    iget-object v0, p0, Landroidx/mediarouter/app/d;->u:Landroid/widget/FrameLayout;

    invoke-direct {p0, v0, v7}, Landroidx/mediarouter/app/d;->a(Landroid/view/View;I)V
    ...
    invoke-static {v1, v0}, Landroidx/mediarouter/app/d;->b(Landroid/view/View;I)V

    iget-object v0, p0, Landroidx/mediarouter/app/d;->F:Landroidx/mediarouter/app/OverlayListView;

    invoke-static {v0, v4}, Landroidx/mediarouter/app/d;->b(Landroid/view/View;I)V

    iget-object v0, p0, Landroidx/mediarouter/app/d;->u:Landroid/widget/FrameLayout;

    invoke-static {v0, v7}, Landroidx/mediarouter/app/d;->b(Landroid/view/View;I)V
    ...
    invoke-direct {p0, p1}, Landroidx/mediarouter/app/d;->h(Z)V

    return-void
.end method

.method public g()Ld/t/b/k$g;
    .locals 1
...
.method l()V
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/d;->e1:Landroid/view/animation/Interpolator;

    goto :goto_0

    :cond_0
    iget-object v0, p0, Landroidx/mediarouter/app/d;->f1:Landroid/view/animation/Interpolator;

    :goto_0
    iput-object v0, p0, Landroidx/mediarouter/app/d;->d1:Landroid/view/animation/Interpolator;

    goto :goto_1

    :cond_1
    iget-object v0, p0, Landroidx/mediarouter/app/d;->g1:Landroid/view/animation/Interpolator;
...
.method n()V
    ...
    invoke-direct {p0}, Landroidx/mediarouter/app/d;->r()V
    ...
    invoke-virtual {p0, v0}, Landroidx/mediarouter/app/d;->b(Z)V
...
.method o()V
    ...
    invoke-direct {p0}, Landroidx/mediarouter/app/d;->t()Z
    ...
    :cond_0
    iget-object v0, p0, Landroidx/mediarouter/app/d;->P0:Landroidx/mediarouter/app/d$n;
    ...
    iput-object v0, p0, Landroidx/mediarouter/app/d;->P0:Landroidx/mediarouter/app/d$n;
...
.method public onAttachedToWindow()V
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/d;->f:Ld/t/b/k;

    sget-object v1, Ld/t/b/j;->d:Ld/t/b/j;

    iget-object v2, p0, Landroidx/mediarouter/app/d;->g:Landroidx/mediarouter/app/d$p;

    const/4 v3, 0x2

    invoke-virtual {v0, v1, v2, v3}, Ld/t/b/k;->a(Ld/t/b/j;Ld/t/b/k$a;I)V
    ...
    invoke-direct {p0, v0}, Landroidx/mediarouter/app/d;->a(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    sget v0, Ld/t/a$j;->mr_controller_material_dialog_b:I
    ...
    sget v2, Ld/t/a$g;->mr_expandable_area:I
    ...
    sget v2, Ld/t/a$g;->mr_dialog_area:I
    ...
    invoke-static {v2}, Landroidx/mediarouter/app/j;->c(Landroid/content/Context;)I
    ...
    sget v4, Ld/t/a$k;->mr_controller_disconnect:I
    ...
    sget v4, Ld/t/a$k;->mr_controller_stop_casting:I
    ...
    sget v2, Ld/t/a$g;->mr_custom_control:I
    ...
    sget v2, Ld/t/a$g;->mr_default_control:I
    ...
    sget v3, Ld/t/a$g;->mr_control_title_container:I
    ...
    sget v2, Ld/t/a$g;->mr_media_main_control:I
    ...
    sget v2, Ld/t/a$g;->mr_control_divider:I
    ...
    sget v2, Ld/t/a$g;->mr_playback_control:I
    ...
    sget v2, Ld/t/a$g;->mr_control_title:I
    ...
    sget v2, Ld/t/a$g;->mr_control_subtitle:I
    ...
    sget v2, Ld/t/a$g;->mr_control_playback_ctrl:I
    ...
    sget v0, Ld/t/a$g;->mr_volume_control:I
    ...
    sget v0, Ld/t/a$g;->mr_volume_slider:I
    ...
    sget v0, Ld/t/a$g;->mr_volume_group_list:I
    ...
    sget v0, Ld/t/a$g;->mr_group_expand_collapse:I
    ...
    sget v1, Ld/t/a$h;->mr_controller_volume_group_list_animation_duration_ms:I
    ...
    sget v1, Ld/t/a$h;->mr_controller_volume_group_list_fade_in_duration_ms:I
    ...
    sget v1, Ld/t/a$h;->mr_controller_volume_group_list_fade_out_duration_ms:I
    ...
    invoke-virtual {p0, p1}, Landroidx/mediarouter/app/d;->a(Landroid/os/Bundle;)Landroid/view/View;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    :cond_1
    :goto_0
    iget-object p2, p0, Landroidx/mediarouter/app/d;->h:Ld/t/b/k$g;
    ...
    :goto_1
    invoke-virtual {p2, p1}, Ld/t/b/k$g;->b(I)V
...
.method p()V
    ...
    sget v1, Ld/t/a$e;->mr_controller_volume_group_list_item_icon_size:I
    ...
    sget v1, Ld/t/a$e;->mr_controller_volume_group_list_item_height:I
    ...
    sget v1, Ld/t/a$e;->mr_controller_volume_group_list_max_height:I
    ...
    iput-object v0, p0, Landroidx/mediarouter/app/d;->Q0:Landroid/graphics/Bitmap;

    iput-object v0, p0, Landroidx/mediarouter/app/d;->R0:Landroid/net/Uri;

    invoke-virtual {p0}, Landroidx/mediarouter/app/d;->o()V

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Landroidx/mediarouter/app/d;->d(Z)V
