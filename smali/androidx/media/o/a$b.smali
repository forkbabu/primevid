.class public Landroidx/media/o/a$b;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/media/o/a$b;->e:[I
...
.method public static a(Landroid/app/Notification;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    :cond_0
    invoke-static {p0, v2}, Landroidx/core/app/i;->a(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/IBinder;
...
.method private a(Landroidx/core/app/o$b;)Landroid/widget/RemoteViews;
    ...
    sget v3, Landroidx/media/l$g;->notification_media_action:I

    invoke-direct {v1, v2, v3}, Landroid/widget/RemoteViews;-><init>(Ljava/lang/String;I)V

    sget v2, Landroidx/media/l$e;->action0:I
    ...
    sget v0, Landroidx/media/l$e;->action0:I
...
.method a(I)I
    ...
    sget p1, Landroidx/media/l$g;->notification_template_big_media_narrow:I

    goto :goto_0

    :cond_0
    sget p1, Landroidx/media/l$g;->notification_template_big_media:I
...
.method a(Landroid/app/Notification$MediaStyle;)Landroid/app/Notification$MediaStyle;
    ...
    iget-object v0, p0, Landroidx/media/o/a$b;->e:[I
    ...
    :cond_0
    iget-object v0, p0, Landroidx/media/o/a$b;->f:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public a(Landroid/app/PendingIntent;)Landroidx/media/o/a$b;
    .locals 0

    iput-object p1, p0, Landroidx/media/o/a$b;->h:Landroid/app/PendingIntent;

    return-object p0
.end method

.method public a(Landroid/support/v4/media/session/MediaSessionCompat$Token;)Landroidx/media/o/a$b;
    .locals 0

    iput-object p1, p0, Landroidx/media/o/a$b;->f:Landroid/support/v4/media/session/MediaSessionCompat$Token;

    return-object p0
.end method

.method public a(Z)Landroidx/media/o/a$b;
    .locals 2
    ...
    iput-boolean p1, p0, Landroidx/media/o/a$b;->g:Z

    :cond_0
    return-object p0
.end method

.method public varargs a([I)Landroidx/media/o/a$b;
    .locals 0

    iput-object p1, p0, Landroidx/media/o/a$b;->e:[I
...
.method public a(Landroidx/core/app/n;)V
    ...
    :cond_0
    iget-boolean v0, p0, Landroidx/media/o/a$b;->g:Z
...
.method b()Landroid/widget/RemoteViews;
    ...
    iget-object v0, v0, Landroidx/core/app/o$g;->b:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Landroidx/media/o/a$b;->a(I)I

    move-result v1

    const/4 v2, 0x0

    invoke-virtual {p0, v2, v1, v2}, Landroidx/core/app/o$p;->a(ZIZ)Landroid/widget/RemoteViews;

    move-result-object v1

    sget v3, Landroidx/media/l$e;->media_actions:I
    ...
    iget-object v4, v4, Landroidx/core/app/o$g;->b:Ljava/util/ArrayList;

    invoke-virtual {v4, v3}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Landroidx/core/app/o$b;

    invoke-direct {p0, v4}, Landroidx/media/o/a$b;->a(Landroidx/core/app/o$b;)Landroid/widget/RemoteViews;

    move-result-object v4

    sget v5, Landroidx/media/l$e;->media_actions:I
    ...
    sget v0, Landroidx/media/l$e;->cancel_action:I
    ...
    sget v3, Landroidx/media/l$f;->cancel_button_image_alpha:I
    ...
    iget-object v2, p0, Landroidx/media/o/a$b;->h:Landroid/app/PendingIntent;
...
.method c()Landroid/widget/RemoteViews;
    ...
    invoke-virtual {p0}, Landroidx/media/o/a$b;->d()I
    ...
    invoke-virtual {p0, v2, v0, v1}, Landroidx/core/app/o$p;->a(ZIZ)Landroid/widget/RemoteViews;
    ...
    iget-object v4, p0, Landroidx/media/o/a$b;->e:[I
    ...
    iget-object v6, p0, Landroidx/core/app/o$p;->a:Landroidx/core/app/o$g;

    iget-object v6, v6, Landroidx/core/app/o$g;->b:Ljava/util/ArrayList;

    iget-object v7, p0, Landroidx/media/o/a$b;->e:[I
    ...
    invoke-direct {p0, v6}, Landroidx/media/o/a$b;->a(Landroidx/core/app/o$b;)Landroid/widget/RemoteViews;

    move-result-object v6

    sget v7, Landroidx/media/l$e;->media_actions:I
    ...
    :cond_2
    iget-boolean v1, p0, Landroidx/media/o/a$b;->g:Z

    const/16 v3, 0x8

    if-eqz v1, :cond_3

    sget v1, Landroidx/media/l$e;->end_padder:I

    invoke-virtual {v0, v1, v3}, Landroid/widget/RemoteViews;->setViewVisibility(II)V

    sget v1, Landroidx/media/l$e;->cancel_action:I
...
.method d()I
    ...
    sget v0, Landroidx/media/l$g;->notification_template_media:I
