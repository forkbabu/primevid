...
.method private final a(Ljava/net/Proxy;Lm/v;)Ljava/net/InetAddress;
    .locals 2
    ...
    invoke-virtual {p2}, Lm/v;->A()Ljava/lang/String;
...
.method public a(Lm/h0;Lm/f0;)Lm/d0;
    ...
    invoke-virtual/range {p2 .. p2}, Lm/f0;->y()Ljava/util/List;

    move-result-object v1

    invoke-virtual/range {p2 .. p2}, Lm/f0;->V()Lm/d0;
    ...
    invoke-virtual/range {p2 .. p2}, Lm/f0;->B()I
    ...
    invoke-virtual/range {p1 .. p1}, Lm/h0;->e()Ljava/net/Proxy;
    ...
    invoke-static {v9, v8, v5}, Ll/w2/s;->c(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v6, v8}, Ll/n2/t/i0;->a(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-direct {v0, v6, v4}, Lm/x;->a(Ljava/net/Proxy;Lm/v;)Ljava/net/InetAddress;
    ...
    invoke-virtual {v4}, Lm/v;->L()Ljava/lang/String;

    move-result-object v13

    invoke-virtual {v7}, Lm/h;->g()Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lm/v;->O()Ljava/net/URL;
    ...
    :cond_5
    invoke-virtual {v4}, Lm/v;->A()Ljava/lang/String;
    ...
    invoke-virtual {v7}, Lm/h;->f()Ljava/nio/charset/Charset;

    move-result-object v4

    invoke-static {v2, v5, v4}, Lm/o;->a(Ljava/lang/String;Ljava/lang/String;Ljava/nio/charset/Charset;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v3}, Lm/d0;->l()Lm/d0$a;

    move-result-object v3

    invoke-virtual {v3, v1, v2}, Lm/d0$a;->b(Ljava/lang/String;Ljava/lang/String;)Lm/d0$a;
